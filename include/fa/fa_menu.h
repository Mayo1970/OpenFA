/*
 * fa_menu.h - the title / world-select screen
 *
 ...
 *
 * Frame states: the exe picks frame 0/1 for an "unavailable" world and 2/3
 * for an "available" one, +1 more on hover, and frame 4 while pressed. There
 * is no progression state, so every world is available: the port uses frame
 * 2 rest / 3 hover / 4 pressed. CLASSIFICA and ESCI have
